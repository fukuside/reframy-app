    ...
    questions: [
      {
        ...
        evaluation: {
          ...
          negative_keywords: ["行きなさい", "だめ", "甘えるな","誰のため","何のため"],
    ...
    questions: [
      {
        ...
        evaluation: {
          ...
          negative_keywords: ["すぐ片付けなさい", "だらしない","すぐ","もう","やめなさい"],
    ...
    questions: [
      {
        ...
        advice: "編集予定",
        evaluation: {
          positive_keywords: ["遊ぶ", "アヒル", "競争", "楽しい","お風呂いや？","入りたくない"],
          negative_keywords: ["入りなさい", "だめ", "早く","もう","やめなさい","なんで"],
    ...
    questions: [
      {
        ...
        evaluation: {
          positive_keywords: ["順番", "気持ちを聞く", "落ち着いて", "話して","それぞれの意見"],
          negative_keywords: ["怒らない", "うるさい", "どっちも悪い","二人とも悪い"],
    ...
    questions: [
      {
        ...
        evaluation: {
          ...
          negative_keywords: ["だめ", "食べなさい", "わがまま言わない","とりあげ","食べななくても"],
    ...
    questions: [
      {
        ...
        evaluation: {
          positive_keywords: ["落ち着く", "気が進まない", "一緒に考えよう", "出かける理由", "不安","どんなことがある","ありがとう"],
          negative_keywords: ["早くして","早く","わがまま", "外に出なさい"],
    ...
    questions: [
      {
        ...
        evaluation: {
          positive_keywords: ["あと3分", "お話きかせて", "タイマー", "区切り","楽しかった","お布団","寝る準備","今日","のこと"],
          negative_keywords: ["寝なさい", "早く", "いい加減にして","無理","やめなさい","起き"],
